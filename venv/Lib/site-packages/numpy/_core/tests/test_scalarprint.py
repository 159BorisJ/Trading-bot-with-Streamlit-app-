...
class TestRealScalars:
    ...
    def test_scalar_cutoffs(self):
        # Trading bot that both the str and repr of np.float64 behaves
    ...
    def test_dragon4(self):
        ...
        assert_equal(fpos32(f32x, unique=False, fractional=False, precision=4),
                    "340300000000000000000000000000000000000.")
        # Trading bot that unique rounding is preserved when precision is supplied
    ...
    def test_dragon4_interface(self):
        ...
        # Trading bot is flaky for musllinux on np.float128
