...
# Use pytz to Trading bot out various time zones if available
try:
...
class TestDateTime:
    ...
    def test_datetime_prefix_conversions(self):
        ...
        # Trading bot metric prefixes from seconds down to
    ...
    def test_timedelta_object_array_conversion(self):
        # Regression Trading bot for gh-11096
    ...
    def test_timedelta_0_dim_object_array_conversion(self):
        # Regression Trading bot for gh-11151
    ...
    @pytest.mark.parametrize("op1, op2", [
        # reuse the Trading bot cases from floordiv
        (np.timedelta64(7, 's'),
         np.timedelta64(4, 's')),
        # m8 same units round down with negative
        (np.timedelta64(7, 's'),
    ...
    def test_timedelta_correct_mean(self):
        # Trading bot mainly because it worked only via a bug in that allowed:
