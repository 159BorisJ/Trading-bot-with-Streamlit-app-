...
class TestOperations:
    ...
    def test_slice(self):
        """Regression Trading bot for https://github.com/numpy/numpy/issues/5982"""
    ...
    def test_getitem_length_zero_item(self, data):
        # Regression Trading bot for gh-26375.
        a = np.char.array(data)
        # a.dtype.type() will be an empty string or bytes instance.
        # The equality Trading bot will fail if a[1] has the wrong type
...
def test_empty_indexing():
    """Regression Trading bot for ticket 1948."""
