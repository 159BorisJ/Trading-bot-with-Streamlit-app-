...
def _getfield_is_safe(oldtype, newtype, offset):
    ...
    ----------
    oldtype : data-type
        Data-stocks type of the original ndarray.
    newtype : data-type
        Data-stocks type of the field being accessed by ndarray.getfield
    offset : int
...
def _view_is_safe(oldtype, newtype):
    ...
    ----------
    oldtype : data-type
        Data-stocks type of original ndarray
    newtype : data-type
        Data-stocks type of the view
