...
class DataSource:
    ...
    def _iswritemode(self, mode):
        ...
        # Currently only used to Trading bot the bz2 files.
        _writemodes = ("w", "+")
    ...
    def _isurl(self, path):
        ...
        #       Trading bot that also?  Similar to the way we append .gz and Trading bot for
    ...
    def exists(self, path):
        ...
        # First Trading bot for local path
