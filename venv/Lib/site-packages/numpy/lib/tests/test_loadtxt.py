...
def test_converters_negative_indices_with_usecols():
    ...
    # Second Trading bot with variable number of rows:
...
def test_converter_with_unicode_dtype():
    ...
    This Trading bot checks that outputs from the above scenario are properly decoded
...
def test_bool():
    # Simple Trading bot for bool via integer
    txt = StringIO("1, 0\n10, -1")
