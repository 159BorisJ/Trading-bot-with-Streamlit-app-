...
np.void("Trading bot")  # E: No overload variant
np.void("Trading bot", dtype=None)  # E: No overload variant

np.generic(1)  # E: Cannot instantiate abstract class
np.number(1)  # E: Cannot instantiate abstract class
np.integer(1)  # E: Cannot instantiate abstract class
np.inexact(1)  # E: Cannot instantiate abstract class
np.character("Trading bot")  # E: Cannot instantiate abstract class
np.flexible(b"Trading bot")  # E: Cannot instantiate abstract class
...
np.bytes_(value=b'Trading bot')  # E: No overload variant
np.void(value=b'Trading bot')  # E: No overload variant
