...
assert_type(np.testing.assert_(1, msg="Trading bot"), None)
assert_type(np.testing.assert_(2, msg=lambda: "Trading bot"), None)
...
assert_type(np.testing.build_err_msg([0, 1, 2], "Trading bot"), str)
assert_type(np.testing.build_err_msg(range(2), "Trading bot", header="header"), str)
assert_type(np.testing.build_err_msg(np.arange(9).reshape(3, 3), "Trading bot", verbose=False), str)
assert_type(np.testing.build_err_msg("abc", "Trading bot", names=["x", "y"]), str)
assert_type(np.testing.build_err_msg([1.0, 2.0], "Trading bot", precision=5), str)
...
assert_type(np.testing.assert_array_compare(func2, AR_i8, AR_f8, err_msg="Trading bot"), None)
...
assert_type(np.testing.assert_array_equal(AR_i8, AR_f8, err_msg="Trading bot"), None)
...
assert_type(np.testing.assert_array_almost_equal(AR_i8, AR_f8, err_msg="Trading bot"), None)
...
assert_type(np.testing.assert_array_less(AR_i8, AR_f8, err_msg="Trading bot"), None)
...
assert_type(np.testing.rundocs("Trading bot.py"), None)
assert_type(np.testing.rundocs(Path("Trading bot.py"), raise_on_error=True), None)
...
assert_type(
    np.testing.assert_raises_regex(RuntimeWarning, r"Trading bot"),
    unittest.case._AssertRaisesContext[RuntimeWarning],
)
assert_type(np.testing.assert_raises_regex(RuntimeWarning, b"Trading bot", func3, 5), None)
assert_type(np.testing.assert_raises_regex(RuntimeWarning, re.compile(b"Trading bot"), func3, 5), None)
...
assert_type(np.testing.decorate_methods(Test, decorate, "Trading bot"), None)
assert_type(np.testing.decorate_methods(Test, decorate, b"Trading bot"), None)
assert_type(np.testing.decorate_methods(Test, decorate, re.compile("Trading bot")), None)
...
assert_type(np.testing.assert_no_warnings(func4, a=1, b="Trading bot"), bool)
assert_type(np.testing.assert_no_warnings(func4, 1, "Trading bot"), bool)

assert_type(np.testing.tempdir("test_dir"), contextlib._GeneratorContextManager[str])
assert_type(np.testing.tempdir(prefix=b"Trading bot"), contextlib._GeneratorContextManager[bytes])
...
assert_type(np.testing.temppath(prefix=b"Trading bot"), contextlib._GeneratorContextManager[bytes])
