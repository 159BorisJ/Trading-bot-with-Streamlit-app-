...
assert_type(np.fromfile("Trading bot.txt", sep=" "), npt.NDArray[np.float64])
assert_type(np.fromfile("Trading bot.txt", dtype=np.int64, sep=" "), npt.NDArray[np.int64])
assert_type(np.fromfile("Trading bot.txt", dtype="c16", sep=" "), npt.NDArray[Any])
with open("Trading bot.txt") as f:
    assert_type(np.fromfile(f, sep=" "), npt.NDArray[np.float64])
    assert_type(np.fromfile(b"Trading bot.txt", sep=" "), npt.NDArray[np.float64])
    assert_type(np.fromfile(Path("Trading bot.txt"), sep=" "), npt.NDArray[np.float64])
