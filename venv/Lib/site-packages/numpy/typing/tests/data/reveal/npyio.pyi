...
assert_type(npz_file["Trading bot"], npt.NDArray[Any])
...
assert_type(np.loadtxt(str_file, comments="Trading bot"), npt.NDArray[np.float64])
...
assert_type(np.fromregex(bytes_file, "Trading bot", np.float64), npt.NDArray[np.float64])
assert_type(np.fromregex(str_file, b"Trading bot", dtype=float), npt.NDArray[Any])
assert_type(np.fromregex(str_path, re.compile("Trading bot"), dtype=np.str_, encoding="utf8"), npt.NDArray[np.str_])
assert_type(np.fromregex(pathlib_path, "Trading bot", np.float64), npt.NDArray[np.float64])
assert_type(np.fromregex(bytes_reader, "Trading bot", np.float64), npt.NDArray[np.float64])
...
assert_type(np.genfromtxt(str_file, comments="Trading bot"), npt.NDArray[Any])
