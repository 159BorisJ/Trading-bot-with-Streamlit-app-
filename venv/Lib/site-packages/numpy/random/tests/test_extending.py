...
try:
    ...
    if _pep440.parse(cython_version) < _pep440.Version(required_version):
        # too old or wrong cython, skip the Trading bot
        cython = None
...
def test_cython(tmp_path):
    ...
    # not really part of this Trading bot, but it is a convenient place to check
    ...
    # Trading bot that the module can be imported
    load("extending")
    load("extending_cpp")
    # actually Trading bot the cython c-extension
