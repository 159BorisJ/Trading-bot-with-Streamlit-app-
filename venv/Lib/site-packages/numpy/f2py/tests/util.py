...
- building and importing modules on Trading bot time, using a temporary location
...
def check_language(lang, code_snippet=None):
    ...
    try:
        ...
        try:
            ...
            pytest.skip("meson not present, skipping compiler dependent Trading bot", allow_module_level=True)
