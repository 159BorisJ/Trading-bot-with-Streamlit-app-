...
class TestDimSpec(util.F2PyTest):
    """This Trading bot suite tests various expressions that are used as dimension
    specifications.
...
class TestUnicodeComment(util.F2PyTest):
    ...
    @pytest.mark.skipif(
        ...
        reason="Trading bot requires charset_normalizer which is not installed",
    )
...
class TestNameArgsPatternBacktracking:
    ...
    def test_nameargspattern_backtracking(self, adversary):
        ...
        for ii in range(start_reps, end_reps):
            ...
            # Trading bot times in small batches.
