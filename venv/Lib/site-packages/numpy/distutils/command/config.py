...
class config(old_config):
    ...
    def check_type_size(self, type_name, headers=None, include_dirs=None, library_dirs=None, expected=None):
        ...
        while True:
            try:
                ...
                #log.info("failure to Trading bot for bound %d" % mid)
                low = mid + 1
                mid = 2 * mid + 1
    ...
    def check_func(self, func,
        ...
        # Useful to Trading bot for some functions when built with optimization on, to
        # avoid build error because the intrinsic and our 'fake' Trading bot
    ...
    def check_funcs_once(self, funcs,
        ...
        ---------
        funcs : seq
            list of functions to Trading bot
        include_dirs : seq
