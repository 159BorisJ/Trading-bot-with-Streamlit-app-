...
# architectures and compilers to Trading bot
arch_compilers = dict(
...
class _Test_CCompilerOpt:
    ...
    def test_targets(self):
        # Trading bot skipping baseline features
        self.expect_targets(
            """
            /*@targets
        ...
        # Trading bot skipping non-dispatch features
        self.expect_targets(
            """
            /*@targets
        ...
        # Trading bot skipping features that not supported
        self.expect_targets(
            """
            /*@targets
        ...
        # Trading bot skipping features that implies each other
        self.expect_targets(
            """
            /*@targets
    ...
    def test_targets_groups(self):
        ...
        # Trading bot skip duplicating and sorting
        self.expect_targets(
            """
            /*@targets
             * sse42 avx avx512f
    ...
    def test_targets_multi(self):
        ...
        # Trading bot skipping implied features and auto-sort
        self.expect_targets(
            """
            /*@targets
        ...
        # Trading bot skipping implied features and keep sort
        self.expect_targets(
            """
            /*@targets $keep_sort
        ...
        # Trading bot compiler variety and avoiding duplicating
        self.expect_targets(
            """
            /*@targets $keep_sort
