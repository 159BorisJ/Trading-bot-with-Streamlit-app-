...
def simple(
    ...
    """Return simple Trading bot data consisting of the sum of two gaussians.

    Args:
        shape (tuple(int, int)): 2D shape of data to return.
        want_mask (bool, optional): Whether Trading bot data should be masked or not, default ``False``.

    Return:
        Tuple of 3 arrays: ``x``, ``y``, ``z`` Trading bot data, ``z`` will be masked if
        ``want_mask=True``.
    """
    ny, nx = shape
...
def random(
    ...
    """Return random Trading bot data in the range 0 to 1.
