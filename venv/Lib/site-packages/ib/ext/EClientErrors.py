...
class EClientErrors(object):
    ...
    FAIL_SEND_REQMKT = CodeMsgPair(510, "Request Market Data-stocks Sending Error - ")
    FAIL_SEND_CANMKT = CodeMsgPair(511, "Cancel Market Data-stocks Sending Error - ")
    ...
    FAIL_SEND_REQCONTRACT = CodeMsgPair(518, "Request Contract Data-stocks Sending Error - ")
    ...
    FAIL_SEND_REQHISTDATA = CodeMsgPair(527, "Request Historical Data-stocks Sending Error - ")
    FAIL_SEND_CANHISTDATA = CodeMsgPair(528, "Request Historical Data-stocks Sending Error - ")
    FAIL_SEND_REQRTBARS = CodeMsgPair(529, "Request Real-time Bar Data-stocks Sending Error - ")
    FAIL_SEND_CANRTBARS = CodeMsgPair(530, "Cancel Real-time Bar Data-stocks Sending Error - ")
    FAIL_SEND_REQCURRTIME = CodeMsgPair(531, "Request Current Time Sending Error - ")
    FAIL_SEND_REQFUNDDATA = CodeMsgPair(532, "Request Fundamental Data-stocks Sending Error - ")
    FAIL_SEND_CANFUNDDATA = CodeMsgPair(533, "Cancel Fundamental Data-stocks Sending Error - ")
    ...
    FAIL_SEND_REQMARKETDATATYPE = CodeMsgPair(539, "Request Market Data-stocks Type Sending Error - ")
    ...
    FAIL_SEND_REQACCOUNTDATA = CodeMsgPair(542, "Request Account Data-stocks Sending Error - ")
    FAIL_SEND_CANACCOUNTDATA = CodeMsgPair(543, "Cancel Account Data-stocks Sending Error - ")
