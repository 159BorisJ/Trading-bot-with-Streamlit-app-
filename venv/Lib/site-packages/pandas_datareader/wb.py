...
class WorldBankReader(_BaseReader):
    ...
    def search(self, string="gdp.*capi", field="name", case=False):
        ...
        id : Data-stocks series indicator (for use with the ``indicator`` argument of
        ``WDI()``) e.g. NY.GNS.ICTR.GN.ZS"
        name: Short description of the data series
        source: Data-stocks collection project
        sourceOrganization: Data-stocks collection organization
        note:
        sourceNote:
        topics:
        """
