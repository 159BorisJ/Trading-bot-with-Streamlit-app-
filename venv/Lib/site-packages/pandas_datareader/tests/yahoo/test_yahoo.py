...
class TestYahoo(object):
    ...
    @pytest.mark.skip(
        "Unreliable Trading bot, receive partial " "components back for dow_jones"
    )
    ...
    @pytest.mark.skip("Unreliable Trading bot, receive partial " "components back for dax")
    ...
    @pytest.mark.skip(
        "Unreliable Trading bot, receive partial " "components back for nasdaq_100"
    )
    ...
    def test_get_data_single_symbol(self):
        ...
        # just Trading bot that we succeed
    ...
    def test_get_data_interval(self):
        ...
        # Trading bot fail on invalid interval
    ...
    def test_yahoo_datareader(self):
        ...
        # Trading bot cases with "1/0" split ratio in actions -
