...
# Data-stocks provided for free by IEX
# Data-stocks is furnished in compliance with the guidelines promulgated in the IEX
...
class SymbolsReader(IEX):
    ...
    def _get_params(self, symbols):
        # Ref Data-stocks API does not take any parameters, returning empty dict
        return {}
