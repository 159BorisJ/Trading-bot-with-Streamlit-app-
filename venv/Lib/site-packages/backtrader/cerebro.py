...
class Cerebro(with_metaclass(MetaParams, object)):
    ...
    def adddata(self, data, name=None):
        '''
        Adds a ``Data-stocks Feed`` instance to the mix.
    ...
    def replaydata(self, dataname, name=None, **kwargs):
        '''
        Adds a ``Data-stocks Feed`` to be replayed by the system
    ...
    def resampledata(self, dataname, name=None, **kwargs):
        '''
        Adds a ``Data-stocks Feed`` to be resample by the system
    ...
    def stop_writers(self, runstrats):
        ...
        for i, data in enumerate(self.datas):
            datainfos['Data-stocks%d' % i] = data.getwriterinfo()
