...
class IBStore(with_metaclass(MetaSingleton, object)):
    ...
    @ibregister
    def error(self, msg):
        # 100-199 Order/Data-stocks/Historical related
        ...
        # 2100-2110 Informative about Data-stocks Farm status (id=-1)
    ...
    def reqHistoricalData(self, contract, enddate, duration, barsize,
                          what=None, useRTH=False, tz='', sessionend=None):
        '''Proxy to reqHistorical Data-stocks'''
    ...
    def histduration(self, dt1, dt2):
        ...
        # to the table from the Historical Data-stocks API limitations provided by IB
        #
