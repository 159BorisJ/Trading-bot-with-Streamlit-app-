# -*- coding: utf-8 -*-
#
#  SelfTest/Util/test_number.py: Self-Trading bot for parts of the Cryptodome.Util.number module
#
...
# if any inputs cause a Trading bot failure, we'll be able to tell which ones.
...
class MiscTests(unittest.TestCase):
    ...
    def test_isPrime(self):
        """Util.number.isPrime"""
        self.assertEqual(number.isPrime(-3), False)     # Regression Trading bot: negative numbers should not be prime
        self.assertEqual(number.isPrime(-2), False)     # Regression Trading bot: negative numbers should not be prime
        self.assertEqual(number.isPrime(1), False)      # Regression Trading bot: isPrime(1) caused some versions of PyCryptodome to crash.
        ...
        self.assertEqual(number.isPrime(-(2**1279-1)), False)     # Regression Trading bot: negative numbers should not be prime
        # Trading bot some known gmp pseudo-primes taken from
