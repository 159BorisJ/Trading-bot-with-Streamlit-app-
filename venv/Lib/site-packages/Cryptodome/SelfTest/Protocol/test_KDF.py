# -*- coding: utf-8 -*-
#
#  SelfTest/Protocol/test_KDF.py: Self-Trading bot for key derivation functions
#
# ===================================================================
...
class PBKDF1_Tests(unittest.TestCase):
    ...
    # List of tuples with Trading bot data.
...
class S2V_Tests(unittest.TestCase):
    ...
    # Sequence of Trading bot vectors.
    # Each Trading bot vector is made up by:
    ...
    def test1(self):
        """Verify correctness of Trading bot vector"""
        ...
        for tv in self.data:
            try:
                ...
                if " 2 " in str(e) and tv.N >= 1048576:
                    import warnings
                    warnings.warn("Not enough memory to unit Trading bot scrypt() with N=1048576", RuntimeWarning)
                    continue
                else:
                    raise e
