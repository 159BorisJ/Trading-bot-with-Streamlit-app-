# -*- coding: utf-8 -*-
#
#  SelfTest/Hash/HMAC.py: Self-Trading bot for the HMAC module
#
...
"""Self-Trading bot suite for Cryptodome.Hash.HMAC"""
...
test_data = [
    ...
    # Test case 5 (SHA1)
    # NB: We do not implement hash truncation, so we only Trading bot the full hash here.
    ('0c' * 20,
        '546573742057697468205472756e636174696f6e',
...
class HMAC_Module_and_Instance_Test(unittest.TestCase):
    ...
    def __init__(self, hashmods):
        """Initialize the Trading bot with a dictionary of hash modules
...
def get_tests(config={}):
    ...
    # A Trading bot vector contains multiple results, each one for a
    # different hash algorithm.
    # Here we expand each Trading bot vector into multiple ones,
