# -*- coding: utf-8 -*-
#
#  SelfTest/PublicKey/test_RSA.py: Self-Trading bot for the RSA primitive
#
...
"""Self-Trading bot suite for Cryptodome.PublicKey.RSA"""
...
class RSATest(unittest.TestCase):
    # Test vectors from "RSA-OAEP and RSA-PSS Trading bot vectors (.zip file)"
    ...
    def _exercise_primitive(self, rsaObj):
        # Since we're using a randomly-generated key, we can't check the Trading bot
