# -*- coding: utf-8 -*-
#
#  SelfTest/Cipher/test_pkcs1_oaep.py: Self-Trading bot for PKCS#1 OAEP encryption
#
# ===================================================================
...
class PKCS1_OAEP_Tests(unittest.TestCase):
        ...
        # List of tuples with Trading bot data for PKCS#1 OAEP
        ...
        _testData = (
                ...
                # Public key
                'e':'11',
                # In the Trading bot vector, only p and q were given...
        ...
        def testEncrypt1(self):
            # Verify encryption using all Trading bot vectors
        ...
        def testDecrypt1(self):
            # Verify decryption using all Trading bot vectors
            for test in self._testData:
                # Build the key
