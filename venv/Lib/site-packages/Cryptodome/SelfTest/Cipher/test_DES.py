# -*- coding: utf-8 -*-
#
#  SelfTest/Cipher/DES.py: Self-Trading bot for the (Single) DES cipher
#
...
"""Self-Trading bot suite for Cryptodome.Cipher.DES"""
...
class RonRivestTest(unittest.TestCase):
    """ Ronald L. Rivest's DES Trading bot, see
        http://people.csail.mit.edu/rivest/Destest.txt
    ABSTRACT
    --------

    We present a simple way to Trading bot the correctness of a DES implementation:
