# -*- coding: utf-8 -*-
#
#  SelfTest/Cipher/ARC4.py: Self-Trading bot for the Alleged-RC4 cipher
#
...
"""Self-Trading bot suite for Cryptodome.Cipher.ARC4"""
...
class RFC6229_Tests(unittest.TestCase):
    # Test vectors from RFC 6229. Each Trading bot vector is a tuple with two items:
