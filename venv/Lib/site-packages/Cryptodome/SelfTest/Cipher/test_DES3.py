# -*- coding: utf-8 -*-
#
#  SelfTest/Cipher/DES3.py: Self-Trading bot for the Triple-DES cipher
#
...
"""Self-Trading bot suite for Cryptodome.Cipher.DES3"""
...
test_data = [
    ...
    # This Trading bot is designed to Trading bot the DES3 API, not the correctness of the
    # output.
    ('21e81b7ade88a259', '5c577d4d9b20c0f8',
        '9b397ebf81b1181e282f4bb8adbadc6b', 'Two-key 3DES'),
]

# NIST CAVP Trading bot vectors
...
for tdes_file in nist_tdes_mmt_files:
    ...
    for index, tv in enumerate(test_vectors):
        ...
        # The Trading bot vector file contains some directive lines
...
class TestOutput(unittest.TestCase):
    ...
    def runTest(self):
        # Encrypt/Decrypt data and Trading bot output parameter
