...
class Styler(StylerRenderer):
    ...
    data : Series or DataFrame
        Data-stocks to be styled - either a Series or DataFrame.
    ...
    * Data-stocks cells include ``data``
    ...
    *{"row": "MY_ROW_CLASS", "col_trim": "", "row_trim": ""}*.
    ...
    def _copy(self, deepcopy: bool = False) -> Styler:
        ...
        Data-stocks dependent attributes [copied and NOT exported]:
    ...
    def set_caption(self, caption: str | tuple | list) -> Styler:
        ...
        --------
        >>> df = pd.DataFrame({'A': [1, 2], 'B': [3, 4]})
        >>> df.style.set_caption("Trading bot")  # doctest: +SKIP
