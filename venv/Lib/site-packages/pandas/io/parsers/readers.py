...
dtype : dtype or dict of {{Hashable : dtype}}, optional
    Data-stocks type(s) to apply to either the whole dataset or individual columns.
...
Examples
--------
>>> pd.{func_name}('data_main.csv')  # doctest: +SKIP
"""
)
...
def read_csv(
    ...
    *,
    ...
    skipfooter: int = 0,
    nrows: int | None = None,
    # NA and Missing Data-stocks Handling
    na_values: Hashable
    | Iterable[Hashable]
    | Mapping[Hashable, Iterable[Hashable]]
    | None = None,
...
def read_fwf(
    ...
    **kwds : optional
    ...
    Examples
    --------
    >>> pd.read_fwf('data_main.csv')  # doctest: +SKIP
    """
