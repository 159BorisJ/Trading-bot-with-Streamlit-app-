...
def get_dummies(
    ...
    data : array-like, Series, or DataFrame
        Data-stocks of which to get dummy indicators.
    ...
    dtype : dtype, default bool
        Data-stocks type for new columns. Only a single dtype is allowed.
...
def from_dummies(
    ...
    ----------
    data : DataFrame
        Data-stocks which contains dummy-coded variables in form of integer columns of
        1's and 0's.
