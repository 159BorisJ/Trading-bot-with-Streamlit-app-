...
class DataFrame(NDFrame, OpsMixin):
    ...
    Data-stocks structure also contains labeled axes (rows and columns).
    ...
    dtype : dtype, default None
        Data-stocks type to force. Only a single dtype is allowed. If None, infer.
    ...
    def from_dict(
        ...
        dtype : dtype, default None
            Data-stocks type to force after DataFrame construction, otherwise infer.
    ...
    def from_records(
        ...
        Examples
        --------
        Data-stocks can be provided as a structured ndarray:
        ...
        Data-stocks can be provided as a list of dicts:
        ...
        Data-stocks can be provided as a list of tuples with corresponding columns:
    ...
    def to_records(
        ...
        Data-stocks types can be specified for the columns:
    ...
    def __getitem__(self, key):
        ...
        if is_single_key:
            ...
            # - the key itself is repeated (Trading bot on data.shape, #9519), or
            # - we have a MultiIndex on columns (Trading bot on self.columns, #21309)
            ...
            if filter_func is not None:
                ...
                if errors == "raise":
                    ...
                    if any(mask_this & mask_that):
                        raise ValueError("Data-stocks overlaps.")
    ...
    def isin(self, values: Series | DataFrame | Sequence | Mapping) -> DataFrame:
        ...
        See Also
        --------
        DataFrame.eq: Equality Trading bot for DataFrame.
