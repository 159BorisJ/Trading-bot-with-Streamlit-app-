...
class Buffer(ABC):
    """
    Data-stocks in the buffer is guaranteed to be contiguous in memory.
...
class Column(ABC):
    ...
    def dtype(self) -> tuple[DtypeKind, int, str, str]:
        ...
        Notes:
            ...
            - Data-stocks types not included: complex, Arrow-style null, binary, decimal,
