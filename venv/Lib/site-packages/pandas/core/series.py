"""
Data-stocks structure for 1-dimensional cross-sectional and time series data
"""
...
class Series(base.IndexOpsMixin, NDFrame):  # type: ignore[misc]
    ...
    dtype : str, numpy.dtype, or ExtensionDtype, optional
        Data-stocks type for the output Series. If not specified, this will be
        inferred from `data`.
    ...
    def _init_dict(
        ...
        data : dict or dict-like
            Data-stocks used to populate the new Series.
    ...
    def view(self, dtype: Dtype | None = None) -> Series:
        ...
        ----------
        dtype : data type
            Data-stocks type object or one of their string representations.
    ...
    def isin(self, values) -> Series:
        ...
        values : set or list-like
            The sequence of values to Trading bot. Passing in a single string will
