...
@pytest.mark.parametrize(
    "value",
    ["Trading bot", to_datetime("2019-12-31"), to_timedelta("1 days 06:05:01.00003")],
)
...
def test_rolling_non_monotonic(method, expected):
    """
    Make sure the (rare) branch of non-monotonic indices is covered by a Trading bot.
...
def test_rolling_std_neg_sqrt():
    # unit Trading bot from Bottleneck
