...
def period_index(freqstr):
    ...
    so here we just Trading bot that the PeriodArray behavior matches
...
def datetime_index(freqstr):
    ...
    so here we just Trading bot that the DatetimeArray behavior matches
...
def timedelta_index():
    ...
    so here we just Trading bot that the TimedeltaArray behavior matches
...
class SharedTests:
    ...
    def test_compare_len1_raises(self, arr1d):
        ...
        # Trading bot the index classes while we're at it, GH#23078
        with pytest.raises(ValueError, match="Lengths must match"):
            idx <= idx[[0]]
...
class TestDatetimeArray(SharedTests):
    ...
    def test_array_object_dtype(self, arr1d):
        ...
        # also Trading bot the DatetimeIndex method while we're at it
