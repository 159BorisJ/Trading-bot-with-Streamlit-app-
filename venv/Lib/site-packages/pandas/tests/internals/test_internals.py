...
def block_maker(request):
    """
    Fixture to Trading bot both the internal new_block and pseudo-public make_block.
    """
...
class TestBlockManager:
    ...
    def test_duplicate_ref_loc_failure(self):
        ...
        # Trading bot trying to create block manager with overlapping ref locs
...
class TestIndexing:
    ...
    #
    # This Trading bot applies different indexing routines to block managers and
    ...
    def test_get_slice(self, mgr):
        def assert_slice_ok(mgr, axis, slobj):
            ...
            # we maybe using an ndarray to Trading bot slicing and
