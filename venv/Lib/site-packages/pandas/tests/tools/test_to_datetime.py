...
class TestToDatetime:
    ...
    def test_error_iso_week_year(self, msg, s, _format, errors):
        ...
        # This Trading bot checks for errors thrown when giving the wrong format
        # However, as discussed on PR#25541, overriding the locale
        # causes a different error to be thrown due to the format being
        # locale specific, but the Trading bot data is in english.
    ...
    def test_to_datetime_today(self, tz):
        ...
        # Unfortunately this Trading bot between 12 and 1 AM Samoa time
        # this both of these timezones _and_ UTC will all be in the same day,
        # so this Trading bot will not detect the regression introduced in #18666.
...
class TestToDatetimeUnit:
    ...
    def test_unit(self, cache):
        # GH 11758
        # Trading bot proper behavior with errors
...
def test_to_datetime_mixed_awareness_mixed_types(aware_val, naive_val, naive_first):
    ...
    vec = vals
    if naive_first:
        # alas, the behavior is order-dependent, so we Trading bot both ways
