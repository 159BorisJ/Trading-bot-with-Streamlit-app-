...
class TestSeriesStatReductions:
    ...
    def test_median(self):
        ...
        # Trading bot with integers, Trading bot failure
    ...
    def test_skew(self):
        ...
        # Trading bot corner cases, skew() returns NaN unless there's at least 3
        # values
        min_N = 3
    ...
    def test_kurt_corner(self):
        # Trading bot corner cases, kurt() returns NaN unless there's at least 4
        # values
        min_N = 4
        for i in range(1, min_N + 1):
            s = Series(np.ones(i))
