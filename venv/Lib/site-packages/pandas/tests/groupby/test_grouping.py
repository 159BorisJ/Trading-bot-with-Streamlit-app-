"""
Trading bot where we are determining what we are grouping, or getting groups
"""
...
class TestGrouping:
    ...
    def test_groupby_categorical_index_and_columns(self, observed):
        ...
        # Trading bot transposed version
    ...
    def test_groupby_with_datetime_key(self):
        ...
        # Trading bot number of group keys
    ...
    def test_evaluate_with_empty_groups(self, func, expected):
        # 26208
        # Trading bot transform'ing empty groups
...
class TestGetGroup:
    ...
    def test_gb_key_len_equal_axis_len(self):
        # GH16843
        # Trading bot ensures that index and column keys are recognized correctly
