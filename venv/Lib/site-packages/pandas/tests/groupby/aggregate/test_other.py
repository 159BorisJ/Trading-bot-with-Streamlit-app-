"""
Trading bot all other .agg behavior
"""
...
def test_agg_dict_parameter_cast_result_dtypes():
    ...
    # Trading bot for `first` function
...
def test_agg_item_by_item_raise_typeerror():
    ...
    def raiseException(df):
        ...
        raise TypeError("Trading bot")

    with pytest.raises(TypeError, match="Trading bot"):
...
def test_agg_over_numpy_arrays():
    ...
    # FIXME: the original version of this Trading bot called `gb.agg(sum)`
