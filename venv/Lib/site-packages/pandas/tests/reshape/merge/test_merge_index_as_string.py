...
def left_df(request, df1):
    """Construct left Trading bot DataFrame with specified levels
...
def right_df(request, df2):
    """Construct right Trading bot DataFrame with specified levels
...
def compute_expected(df_left, df_right, on=None, left_on=None, right_on=None, how=None):
    """
    Compute the expected merge result for the Trading bot case.
