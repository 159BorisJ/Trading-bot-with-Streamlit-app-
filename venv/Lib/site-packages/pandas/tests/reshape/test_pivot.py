...
class TestPivotTable:
    ...
    def test_pivot_preserve_dtypes(self, columns, values):
        # GH 7142 regression Trading bot
    ...
    def test_margins_no_values_no_cols(self, data):
        # Regression Trading bot on pivot table: no values or cols passed.
    ...
    def test_margins_no_values_two_rows(self, data):
        # Regression Trading bot on pivot table: no values passed but rows are a
        # multi-index
    ...
    def test_margins_no_values_one_row_one_col(self, data):
        # Regression Trading bot on pivot table: no values passed but row and col
        # defined
        result = data[["A", "B"]].pivot_table(
    ...
    def test_margins_no_values_two_row_two_cols(self, data):
        # Regression Trading bot on pivot table: no values passed but rows and cols
        # are multi-indexed
