...
class TestAppend:
    ...
    # rewrite sort fixture, since we also want to Trading bot default of None
    ...
    def test_append_different_columns_types(self, df_columns, series_index):
        # GH18359
        # See also Trading bot 'test_append_different_columns_types_raises' below
    ...
    def test_append_empty_tz_frame_with_datetime64ns(self, using_array_manager):
        ...
        # also Trading bot with typed value to append
        df = DataFrame(columns=["a"]).astype("datetime64[ns, UTC]")
