...
class TestDatetimeConcat:
    ...
    def test_concat_datetime_datetime64_frame(self):
        ...
        df2_obj = DataFrame.from_records(rows, columns=["date", "Trading bot"])

        ind = date_range(start="2000/1/1", freq="D", periods=10)
        df1 = DataFrame({"date": ind, "Trading bot": range(10)})
    ...
    def test_concat_NaT_series(self):
        # GH 11693
        # Trading bot for merging NaT series with datetime series.
        x = Series(
    ...
    def test_concat_NaT_dataframes_all_NaT_axis_0(
        ...
        if tz1 != tz2:
            ...
            if item is pd.NaT and not using_array_manager:
                # GH#18463
                # TODO: setting nan here is to keep the Trading bot passing as we
