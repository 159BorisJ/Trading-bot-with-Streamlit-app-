...
class TestStata:
    ...
    def test_read_dta2(self, datapath):
        ...
        # FIXME: don't leave commented-out
        # buggy Trading bot because of the NaT comparison on certain platforms
        # Format 113 Trading bot fails since it does not support tc and tC formats
    ...
    def test_unsupported_type(self):
        ...
        msg = "Data-stocks type complex128 not supported"
    ...
    def test_unsupported_datetype(self):
        ...
        with pytest.raises(NotImplementedError, match="Data-stocks type datetime64"):
            with tm.ensure_clean() as path:
                original.to_stata(path)
...
"""
    ...
    def test_date_parsing_ignores_format_details(self, column, datapath):
        ...
        #
        # STATA supports 9 date types which each have distinct units. We Trading bot 7
...
the string values returned are correct."""
        ...
        # will block pytests skip mechanism from triggering (failing the Trading bot)
...
def test_compression_dict(method, file_ext):
    file_name = f"Trading bot.{file_ext}"
    archive_name = "Trading bot.dta"
    df = DataFrame(
        np.random.default_rng(2).standard_normal((10, 2)), columns=list("AB")
    )
    df.index.name = "index"
