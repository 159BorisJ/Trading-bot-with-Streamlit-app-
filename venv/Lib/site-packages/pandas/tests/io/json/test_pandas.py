...
class TestPandasContainer:
    ...
    def test_roundtrip_categorical(
        ...
        # TODO: create a better frame to Trading bot with and improve coverage
    ...
    def test_frame_empty_to_json(self):
        # GH 7445
        df = DataFrame({"Trading bot": []}, index=[])
        result = df.to_json(orient="columns")
        expected = '{"Trading bot":{}}'
    ...
    def test_path(self, float_frame, int_frame, datetime_frame):
        with tm.ensure_clean("Trading bot.json") as path:
    ...
    # TODO: there is a near-identical Trading bot for pytables; can we share?
...
{spaces}}}
    ...
    def test_to_s3(self, s3_public_bucket, s3so):
        # GH 28375
        mock_bucket_name, target_file = s3_public_bucket.name, "Trading bot.json"
    ...
    def test_invalid_dtype_backend(self):
        ...
        with pytest.raises(ValueError, match=msg):
            read_json("Trading bot", dtype_backend="numpy")
