...
def test_buffer_overflow(c_parser_only, malformed):
    # see gh-9205: Trading bot certain malformed input files that cause
...
@td.skip_if_32bit
@pytest.mark.slow
# Trading bot numbers between 1 and 2
...
def test_parse_trim_buffers(c_parser_only, encoding):
    # This Trading bot is part of a bugfix for gh-13703. It attempts to
    # to stress the system memory allocator, to cause it to move the
    # stream buffer and either let the OS reclaim the region, or let
    # other memory requests of parser otherwise modify the contents
    # of memory space, where it was formally located.
    # This Trading bot is designed to cause a `segfault` with unpatched
    # `tokenizer.c`. Sometimes the Trading bot fails on `segfault`, other
...
def test_internal_null_byte(c_parser_only):
    ...
    # none was specified.
    #
    # This Trading bot should be moved to test_common.py ONLY when
...
def test_chunk_whitespace_on_boundary(c_parser_only):
    ...
    #
    # This Trading bot case has a field too large for the Python parser / CSV library.
    parser = c_parser_only
