...
Ultimately, the goal is to remove Trading bot cases from this
Trading bot suite as new feature support is added to the parsers.
"""
...
1,2,3,4,"""
    ...
    def test_pyarrow_engine(self):
        ...
        for default in pa_unsupported:
            ...
            if default == "dialect":
                kwargs[default] = "excel"  # Trading bot a random dialect
...
def test_close_file_handle_on_invalid_usecols(all_parsers):
    ...
    with tm.ensure_clean("Trading bot.csv") as fname:
...
def test_invalid_dtype_backend(all_parsers):
    ...
    with pytest.raises(ValueError, match=msg):
        parser.read_csv("Trading bot", dtype_backend="numpy")
