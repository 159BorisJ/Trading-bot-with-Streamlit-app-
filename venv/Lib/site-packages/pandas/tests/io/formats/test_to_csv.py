...
1.0
"""
        with tm.ensure_clean("Trading bot.csv") as path:
...
"""
        ...
        with tm.ensure_clean("Trading bot.csv") as path:  # QUOTE_ALL
...
z
"""
        with tm.ensure_clean("Trading bot.txt") as path:
