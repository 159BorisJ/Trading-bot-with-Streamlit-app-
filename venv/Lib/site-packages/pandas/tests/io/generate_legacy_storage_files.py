...
branch, and Trading bot using test_pickle.py. This will load the *older*
pickles and Trading bot versus the current data that is generated
...
# import the JSON Trading bot directory as the json module
sys.path.pop(0)
