"""
Base Trading bot suite for extension arrays.
...
* The same module as your Trading bot class.
* A ``conftest.py`` in the same directory as your Trading bot class.
...
wherever the Trading bot requires it. You're free to implement additional tests.
...
# One Trading bot class that you can inherit as an alternative to inheriting all the
# Trading bot classes above.
