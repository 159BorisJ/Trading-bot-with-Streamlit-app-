...
class TestMultiIndexSlicers:
    def test_per_axis_per_level_getitem(self):
        ...
        # Trading bot multi-index slicing with per axis and per index controls
    ...
    def test_loc_ax_single_level_indexer_simple_df(self):
        # GH29519
        # Trading bot single level indexing on single index column data frame
