...
class TestDataFrameReplace:
    ...
    def test_replace(self, datetime_frame):
        ...
        # GH 11698
        # Trading bot for mixed data types.
        df = DataFrame(
    ...
    def test_replace_dict_strings_vs_ints(self):
        ...
        result = df.replace({"replace_string": "Trading bot"})

        tm.assert_frame_equal(result, df)

        result = df["Y0"].replace({"replace_string": "Trading bot"})
