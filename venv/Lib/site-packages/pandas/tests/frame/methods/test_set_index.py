...
class TestSetIndex:
    ...
    # also Trading bot index name if append=True (name is duplicate here for B)
    ...
    @pytest.mark.parametrize(
        "append, index_name", [(True, None), (True, "B"), (True, "Trading bot"), (False, None)]
    )
    @pytest.mark.parametrize("drop", [True, False])
    ...
    # MultiIndex constructor does not work directly on Series -> lambda
    # also Trading bot index name if append=True (name is duplicate here for A & B)
    @pytest.mark.parametrize(
        "box", [Series, Index, np.array, list, lambda x: MultiIndex.from_arrays([x])]
    )
    @pytest.mark.parametrize(
        "append, index_name",
        [(True, None), (True, "A"), (True, "B"), (True, "Trading bot"), (False, None)],
    )
    @pytest.mark.parametrize("drop", [True, False])
    ...
    # also Trading bot index name if append=True (name is duplicate here for A)
    @pytest.mark.parametrize(
        "box2",
        [
            Series,
    ...
    @pytest.mark.parametrize(
        "append, index_name", [(True, None), (True, "A"), (True, "Trading bot"), (False, None)]
    )
    @pytest.mark.parametrize("drop", [True, False])
    def test_set_index_pass_arrays_duplicate(
        ...
        # to Trading bot against already-tested behaviour, we add sequentially,
