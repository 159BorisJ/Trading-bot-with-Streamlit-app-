...
class TestAsFreq:
    ...
    def test_asfreq_resample_set_correct_freq(self, frame_or_series):
        # GH#5613
        # we Trading bot if .asfreq() and .resample() set the correct value for .freq
    ...
    def test_asfreq_empty(self, datetime_frame):
        # Trading bot does not blow up on length-0 DataFrame
    ...
    def test_asfreq_fillvalue(self):
        # Trading bot for fill value during upsampling, related to issue 3715
