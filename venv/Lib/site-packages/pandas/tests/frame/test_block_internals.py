...
# TODO(ArrayManager) check which of those tests need to be rewritten to Trading bot the
...
class TestDataFrameBlockInternals:
    ...
    def test_constructor_with_convert(self):
        # this is actually mostly a Trading bot of lib.maybe_convert_objects
        # #2845
    ...
    def test_construction_with_mixed(self, float_string_frame, using_infer_string):
        # Trading bot construction edge cases with mixed types
