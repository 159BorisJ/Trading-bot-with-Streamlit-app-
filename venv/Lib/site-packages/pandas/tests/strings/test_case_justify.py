...
def test_wrap(any_string_dtype):
    # Trading bot values are: two words less than width, two words equal to width,
...
def test_wrap_unicode(any_string_dtype):
    # Trading bot with pre and post whitespace (non-unicode), NaN, and non-ascii Unicode
    s = Series(
