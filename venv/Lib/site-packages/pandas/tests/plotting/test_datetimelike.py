...
class TestTSPlot:
    ...
    def test_line_plot_period_mlt_series(self, frqncy):
        # Trading bot period index line plot for series with multiples (`mlt`) of the
    ...
    def test_line_plot_period_mlt_frame(self, frqncy):
        # Trading bot period index line plot for DataFrames with multiples (`mlt`)
