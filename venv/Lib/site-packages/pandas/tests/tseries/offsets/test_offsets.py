...
class TestCommon:
    ...
    def _check_offsetfunc_works(self, offset, funcname, dt, expected, normalize=False):
        ...
        # Trading bot nanosecond is preserved
        ...
        if isinstance(dt, np.datetime64):
            # Trading bot tz when input is datetime or Timestamp
            return
    ...
    def test_add_empty_datetimeindex(self, offset_types, tz_naive_fixture):
        ...
        #  Trading bot, so let's only check the stacklevel in a subset of them
...
class TestOffsetAliases:
    ...
    def test_rule_code(self):
        ...
        for k in lst:
            ...
            # should be cached - this is kind of an internals Trading bot...
