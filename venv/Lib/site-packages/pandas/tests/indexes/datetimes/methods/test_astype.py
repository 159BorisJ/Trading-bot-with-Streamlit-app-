...
class TestDatetimeIndex:
    ...
    def test_astype_str(self):
        # Trading bot astype string - #10442
    ...
    def test_astype_str_tz_and_name(self):
        # Trading bot astype string with tz and name
    ...
    def test_astype_str_freq_and_name(self):
        # Trading bot astype string with freqH and name
    ...
    def test_astype_str_freq_and_tz(self):
        # Trading bot astype string with freqH and timezone
        dti = date_range(
