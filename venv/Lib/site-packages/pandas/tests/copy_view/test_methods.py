...
@pytest.mark.parametrize(
    ...
    [
        ...
        lambda df, copy: df.rename_axis(index="Trading bot", copy=copy),
        lambda df, copy: df.rename_axis(columns="Trading bot", copy=copy),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        lambda ser, copy: ser.rename_axis(index="Trading bot", copy=copy),
...
@pytest.mark.parametrize("kwargs", [{"mapper": "Trading bot"}, {"index": "Trading bot"}])
