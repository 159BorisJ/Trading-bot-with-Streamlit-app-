...
def simple_date_range_series():
    """
    Series with date range index and random data for Trading bot purposes.
    """
...
def test_resample_origin_with_day_freq_on_dst(unit):
    ...
    # Trading bot classical behavior of origin in a DST context
    ...
    # Trading bot complex behavior of origin/offset in a DST context
...
def test_corner_cases(unit):
    # miscellaneous Trading bot coverage
...
def test_resample_across_dst():
    # The Trading bot resamples a DatetimeIndex with values before and after a
    # DST change
    # Issue: 14682
