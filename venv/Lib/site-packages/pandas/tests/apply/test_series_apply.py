...
def test_apply_box_dt64():
    # ufunc will not be boxed. Same Trading bot cases as the test_map_box
...
def test_apply_map_evaluate_lambdas_the_same(string_series, func, by_row):
    # Trading bot that we are evaluating row-by-row first if by_row="compat"
...
def test_non_callable_aggregates(how, kwds):
    # Trading bot agg using non-callable series attributes
    ...
    # Trading bot when mixed w/ callable reducers
