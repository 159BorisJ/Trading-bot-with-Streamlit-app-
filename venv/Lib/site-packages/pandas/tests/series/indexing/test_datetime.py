"""
Also Trading bot support for datetime64[ns] in Series / DataFrame
"""
...
def test_getitem_setitem_datetime_tz(tz_source):
    ...
    # also Trading bot Timestamp tz handling, GH #2789
    result = ts.copy()
...
def test_getitem_setitem_datetimeindex():
    ...
    # also Trading bot partial date slicing
...
# Trading bot duplicates in time series
