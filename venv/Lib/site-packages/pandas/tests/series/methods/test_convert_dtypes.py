...
# Each Trading bot case consists of a tuple with the data and dtype to create the
# Trading bot Series, the default dtype for the expected result (which is valid
