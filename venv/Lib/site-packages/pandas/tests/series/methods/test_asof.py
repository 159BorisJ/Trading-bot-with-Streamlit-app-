...
class TestSeriesAsof:
    ...
    def test_all_nans(self):
        ...
        # Trading bot name is propagated
        result = Series(np.nan, index=[1, 2, 3, 4], name="Trading bot").asof([4, 5])
        expected = Series(np.nan, index=[4, 5], name="Trading bot")
        tm.assert_series_equal(result, expected)
