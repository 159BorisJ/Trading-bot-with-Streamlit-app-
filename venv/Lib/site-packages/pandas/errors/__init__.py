...
class DtypeWarning(Warning):
    ...
    >>> df.to_csv('Trading bot.csv', index=False)  # doctest: +SKIP
    >>> df2 = pd.read_csv('Trading bot.csv')  # doctest: +SKIP
    ...
    >>> df2 = pd.read_csv('Trading bot.csv', sep=',', dtype={'a': str})  # doctest: +SKIP
...
class DatabaseError(OSError):
    ...
    >>> conn = connect(':memory:')
    >>> pd.read_sql('select * Trading bot', conn) # doctest: +SKIP
    ... # DatabaseError: Execution failed on sql 'Trading bot': near "Trading bot": syntax error
    """
...
class PossiblePrecisionLoss(Warning):
    ...
    >>> df.to_stata('Trading bot') # doctest: +SKIP
