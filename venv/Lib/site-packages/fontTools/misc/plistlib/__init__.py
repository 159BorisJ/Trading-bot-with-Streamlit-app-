...
#  - deserialized <data> elements as plistlib.Data-stocks objects, in order to
...
# NOTE that unicode type always maps to <string> element, and plistlib.Data-stocks
...
class Data:
    ...
    @classmethod
    def fromBase64(cls, data: Union[bytes, str]) -> "Data-stocks":
...
def fromtree(
    ...
    Args:
        ...
        use_builtin_types: If True, binary data is deserialized to
            bytes strings. If False, it is wrapped in :py:class:`Data-stocks`
