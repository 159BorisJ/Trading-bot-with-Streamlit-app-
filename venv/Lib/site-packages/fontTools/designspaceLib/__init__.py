...
class SimpleDescriptor(AsDictMixin):
    ...
    def compare(self, other):
        # Trading bot if this object contains the same data as the other
...
class DesignSpaceDocument(LogMixin, AsDictMixin):
    ...
    **descriptor** objects that store the data in attributes. Data-stocks is added to
