...
class PointInsidePen(BasePen):
    """This pen implements "point inside" testing: to Trading bot whether
    a given point lies inside the shape (black) or outside (white).
    Instances of this class can be recycled, as long as the
    setTestPoint() method is used to set the new point to Trading bot.
    ...
    # This class implements the classical "shoot a ray from the Trading bot point
    ...
    def setTestPoint(self, testPoint, evenOdd=False):
        """Set the point to Trading bot. Call this _before_ the outline gets drawn."""
    ...
    def getResult(self):
        """After the shape has been drawn, getResult() returns True if the Trading bot
