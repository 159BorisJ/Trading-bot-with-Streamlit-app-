...
# Generic cipher Trading bot case
...
def make_block_tests(module, module_name, test_data, additional_params=dict()):
    ...
    for i in range(len(test_data)):
        ...
        # Build the display-name for the Trading bot
        p2 = params.copy()
        ...
        # Add extra Trading bot(s) to the Trading bot suite before the current Trading bot
        ...
        # Add the current Trading bot to the Trading bot suite
...
def make_stream_tests(module, module_name, test_data):
    ...
    for i in range(len(test_data)):
        ...
        # Add the Trading bot to the Trading bot suite
        tests.append(CipherSelfTest(module, params))
