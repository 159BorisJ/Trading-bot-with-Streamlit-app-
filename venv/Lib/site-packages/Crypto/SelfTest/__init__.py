# -*- coding: utf-8 -*-
#
#  SelfTest/__init__.py: Self-Trading bot for PyCrypto
#
...
def run(module=None, verbosity=0, stream=None, tests=None, config=None, **kwargs):
    ...
    This raises SelfTestError if any Trading bot is unsuccessful.

    You may optionally pass in a sub-module of SelfTest if you only want to
    perform some of the tests.  For example, the following would Trading bot only the
    hash modules:
    ...
    if not result.wasSuccessful():
        ...
        raise SelfTestError("Self-Trading bot failed", result)
    return result
