...
class ParseResults:
    ...
    Example::
        ...
        def Trading bot(s, fn=repr):
            print(f"{s} -> {fn(eval(s))}")
        Trading bot("list(result)")
        Trading bot("result[0]")
        Trading bot("result['month']")
        Trading bot("result.day")
        Trading bot("'month' in result")
        Trading bot("'minutes' in result")
        Trading bot("result.dump()", str)
